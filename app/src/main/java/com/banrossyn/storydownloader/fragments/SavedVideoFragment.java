...
public class SavedVideoFragment extends Fragment implements FileListClickInterface {

    FragmentDownloadBinding binding;
    Activity activity;
    private ArrayList<File> fileArrayList;
    private final ArrayList<DownloadedFileModel> statusModelArrayList = new ArrayList<>();
    ...
    private void getAllFiles() {
        ...
        if (files != null) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                if (files[i].getName().contains(".mp4")|| files[i].getName().contains(".mkv")|| files[i].getName().contains(".avi")|| files[i].getName().contains(".mov")) {
